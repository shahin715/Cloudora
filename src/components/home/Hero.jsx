    ...
    <div className="relative h-screen w-full">
      ...
      <div className="relative z-10 flex items-center justify-center h-full text-center px-6 pt-20">
        <div className="max-w-4xl">
          ...
          >
            Revolutionizing <span className="text-[#22C1DC]">Cloudora</span>{" "}
            Administration with Trusted Expertise and Scalable Software
            Solutions.
          </h1>
          ...
          >
            Leverage our expert team to streamline operations, enhance
            efficiency, and develop tailored solutions that meet your unique
            business needs.
          </p>
